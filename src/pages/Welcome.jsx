    ...
    return (
        ...
        <div className='max-w-[480px] mx-auto relative'>
            ...
            {open ? <div className="relative overflow-hidden max-w-[480px] mx-auto">
                ...
                <div id='fixed' className="relative bg-fixed bg-center bg-cover"
                    style={{
                            ...
                            <div className=' text-gray-200 mt-3'>
                                ...
                                <AnimatedSection animation='fade-in-slide-left'>
                                    <a
                                        ...
                                        className='bg-gray-200/50 mt-4 flex gap-2 items-center justify-center py-2 rounded-md w-60 mx-auto'>
                                        <FaLocationDot />
